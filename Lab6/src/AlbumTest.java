...
public class AlbumTest {
    ...
    public void setUp() {
        ...
        this.repositorioSelos = new Repositorio<>("selosDaCopa",TAMANHO_DO_ALBUM,"selo");
        this.albumSelos = new Album<>(repositorioSelos,ITENS_POR_PACOTE);
    }

    private void popularAlbum(int[] posicoesDesejadas) {
        Pacotinho<Figurinha> pacoteDeFigurinhas = new Pacotinho(this.repositorioFigurinhas, posicoesDesejadas);
        this.albumFigurinhas.receberNovoPacotinho(pacoteDeFigurinhas);
    ...
    @Test
    public void testeGeneric() {
        popularAlbum(new int[] {1, 2, 3});
        this.albumFigurinhas.getItemColado(2);
        this.albumSelos.getItemColado(2);

        assertNotNull(this.albumFigurinhas.getItemColado(2));
        assertNotNull(this.albumSelos.getItemColado(2));

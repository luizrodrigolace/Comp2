...
public class Siguinha {
    ...
    //Feito pro Lab4 (1)
    public static Map<Long,Aluno> alunosCadastrados = new HashMap<>(); // Map<Chave, Valor>

    //Feito pro Lab4 (2)
    void cadastrarAluno(long dre, String nome){
        Aluno alunoParaCadastro = new Aluno(dre,nome);
        alunosCadastrados.put(dre,alunoParaCadastro);
    }
